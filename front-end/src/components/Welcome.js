...
const Welcome = (props) => {
  ...
  return (
    <div className="row text-center welcome-container">
      <h2 className="welcome-title">Welcome to Social-Network</h2>
      <p className="welcome-subtitle">
        Please login or register to start socializing
      </p>
      <div className="col-md-4" style={{ borderRight: "1px solid black" }}>
        <div className=" welcome-logo-div">
          <img
            src={"http://localhost:8080/media/various/logo.png"}
      ...
      <div className="col-md-8">
        <Alert message={props.alertMessage} className={props.alertClassName} />
        <div className=" welcome-forms ">
          <div className="welcome-option-buttons text-center">
            <button
              className={`welcome-login-option-button btn ${
                showLoginForm ? "btn-dark btn-border" : "btn-light btn-border"
              }`}
            ...
            <button
              className={`welcome-register-option-button btn ${
                !showLoginForm ? "btn-dark btn-border" : "btn-light btn-border"
              }`}
                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <Select
                      ...
                      onChange={(event) =>
                        setProfileP(parseInt(event.target.value))
                      }
                    />
                  </div>
                  <div className="col-md-6">
